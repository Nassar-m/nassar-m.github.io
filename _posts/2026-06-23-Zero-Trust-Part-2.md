...
excerpt: "Part 2 of the Entra ID Zero Trust blueprint: eight steps to limit standing access by scope and time — the Enterprise Access Model, PIM, app consent, guest access, and governance — each mapped to the DORA RTS articles a supervisor will test you against."
---
